...
public class TypeConversion {
    ...
    /**
     * return version info
     * 39 31 30 3C 35 36 33 31 32 3E 33 30 33 30 33 31 3C 32 33 3D 3B 3F 34 30 31 36 35 31
     * 91 0C 56 31 2e 30 30 31 C2 3D BF 40 16 51
     *
     * @param hex
     * @return
     */
    public static String[] HexStringConversionVesion(String hex) throws Exception {
        String[] version = new String[2];
        if (hex == null && hex.length() < 42) {
            throw new Exception("the device version has problem !");
        }
        String six1 = hex.substring(6, 24);//56 31 2e 30 30 31 =
        String six2 = hex.substring(25, 42);//C2 3D BF 40 16 51 =
